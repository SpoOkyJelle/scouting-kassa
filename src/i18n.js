export const translations = {
  nl: {
    ...
    no_products_hint: 'Geen producten beschikbaar. Voeg eerst producten toe bij het tabblad Producten.',
  ...
  en: {
    ...
    no_products_hint: 'No products available. Add products first in the Products tab.',
