export const translations = {
  nl: {
    ...
    settings_logo_hint:       'PNG, JPG of SVG — transparante achtergrond aanbevolen. Wordt ook als favicon gebruikt.',
    settings_logo_upload:     'Logo uploaden',
    settings_logo_remove:     'Logo verwijderen',
  ...
  en: {
    ...
    settings_logo_section:    'Logo',
    settings_logo_hint:       'PNG, JPG or SVG — transparent background recommended. Also used as favicon.',
